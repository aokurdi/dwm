...
static const int enablesystray           = 1;   /* 0 = disabled and can't be toggled, 1 = enabled and can be toggled */
...
static const int barheight          = 8;        /* Change bar height */
...
static const char col_blood[]       = "#94151b";
static const char col_piege[]       = "#baae91";
static const char col_flint[]       = "#72685e";
static const char col_white[]       = "#191919";
static const unsigned int baralpha  = OPAQUE;   /* Change this if you want transparent bar to a value between 0x00 and 0xfe */
static const unsigned int borderalpha = OPAQUE; /* Change this if you want transparent borders to a value between 0x00 and 0xfe */
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm]   = { col_flint, col_gray1, col_blood },
	[SchemeSel]    = { col_piege, col_gray2, col_piege },
	[SchemeUline]  = { col_blood, col_gray1, col_piege },
	[SchemeStatus] = { col_piege, col_gray1, col_piege },
};
...
static const Rule rules[] = {
	...
	{ "whatsapp-nativefier-d40211", NULL,       NULL,      1 << 8,        1,             0,           -1 },
...
static const char *dmenucmd[]     = { "dmenu_run", "-b", "-m", dmenumon, "-fn", dmenufont, "-nb", col_white, "-nf", col_piege, "-sb", col_piege, "-sf", col_blood, NULL };
